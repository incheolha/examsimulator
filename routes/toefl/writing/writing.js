...
var addwriting = function(req, res) {
	// console.log('writing 모듈 안에 있는 addwriting 호출됨.');
	...
	// 		// save()로 저장
	// 		// WritingModel 인스턴스 생성
	// 		var writing = new database.WritingModel({
	// 			ExamNO: paramExamNO,
    //             ExamDesc: paramExamDesc,
	// 			contents: paramContents,
	// 			writer: userObjectId
	// 		});
	// 		writing.saveWriting(function(err, result) {
	// 			if (err) {
    //                 if (err) {
	...
	// 		    console.log('글 작성', '포스팅 글을 생성했습니다. : ' + writing._id);
			    
	// 		    return res.redirect('/process/toefl/writing/showwriting/' + writing._id); 
	// 		});
